...
slides: https://docs.google.com/presentation/d/e/2PACX-1vTlAkJtauEjvZsMLYpM9CdODUT7uDQmHesCOkbFIsh-xvznV7_ZgWCXtarYpv-yrvhwYaao1B8AXj7s
paper: http://arxiv.org/abs/1807.09341
code: https://github.com/thanard/causal-infogan
---
<div class="container mb-0.5 block shadowed">
    
  <h1 class="mt-1.5">{{page.title}}</h1>

<iframe src="{{ page.slides }}/embed?start=false&loop=false" frameborder="0" width="1440" height="839" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
